...
export function apply(ctx, rawConfig) {
  ...
  function fail(type, message, httpStatus) {
    ...
    return { ok: false, valid: null, planName: null, remaining: null, unit: '%', extra: null, windows: null, fetchedAt: null, cached: false, stale: false, error: { type, message, httpStatus: httpStatus || null }, credential: null, snapshots: state.snapshots.slice(), parseVersion: PARSE_VERSION }
  }
  ...
  function failTransient(type, message) {
    ...
    return { ok: false, valid: null, planName: null, remaining: null, unit: '%', extra: null, windows: null, fetchedAt: null, cached: false, stale: false, error: { type, message, httpStatus: null }, credential: null, snapshots: state.snapshots.slice(), parseVersion: PARSE_VERSION }
  }
